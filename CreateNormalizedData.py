...
for i in range(1000):
    qualityData[i][0] = processData[i][0]*0.3 + processData[i][1]*0.1 + processData[i][2]*0.05 + processData[i][3]*0.25 + processData[i][4]*0.15 + processData[i][10]*0.15
    qualityData[i][1] = processData[i][5]*0.3 + processData[i][6]*0.1 + processData[i][7]*0.05 + processData[i][8]*0.25 + processData[i][9]*0.15 + processData[i][11]*0.15
    qualityData[i][2] = processData[i][3]*0.3 + processData[i][4]*0.1 + processData[i][5]*0.05 + processData[i][6]*0.25 + processData[i][7]*0.15 + processData[i][12]*0.15
